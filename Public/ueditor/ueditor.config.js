...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
    ['fullscreen', 'source', 'undo', 'redo','bold', 'italic','justifyleft','justifyright','justifycenter','justifyjustify','underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc']
]
