...
<body>
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php/Admin/Goods/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
							...
							<tr>
                                <th>是否上架：</th>
                                <td><input name="is_on_sale"  type="radio" value='1' checked='checked'>是
								<input name="is_on_sale"  type="radio" value='0'>否
								</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>商品描述：</th>
                                <td><textarea name="goods_desc" class="common-textarea" id="goods_desc" cols="120" style="width: 80%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
